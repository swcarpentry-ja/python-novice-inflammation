...
1.  **Not scalable**. Imagine you need to print a list that has hundreds
    of elements.  It might be easier just to type them in manually.
...
hundred-element list --- and more robust as well:
...
![loop_image](../fig/03-loops_image_num.png)
...
number was printed in (1 being the first loop, and 6 being the final loop).
